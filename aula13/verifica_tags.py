...
from typing import TextIO # TextIO , biblioteca  para armazenar o documento.
...
fecha tag correspondente. Caso contrário, retorna False.
    ...
    P = deque() # Criando a pilha vazia

    # percorre linha a linha do documento iterável. O iterador passa linha por linha do html
    for linha in documento:
        ...
        while j != -1: # se for -1 é porque não encontrou 
            ...
            tag = linha[j+1:k] # Pega o texto que está dentro da tag.
    ...
    return len(P) == 0 # Consome todos os elementos da pilha, significa que a pilha ta vazia
